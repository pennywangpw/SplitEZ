...
Revision ID: 971c655258f6
Revises: 
Create Date: 2023-04-26 09:54:18.728489
...
def upgrade():
    ...
    sa.Column('billpayer_user_id', sa.Integer(), nullable=False),
    sa.Column('group_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['billpayer_user_id'], ['users.id'], ),
