            ...
            <div className="backgroud-img height-80-per min-width-600px min-height-500px">
                <div className="flx mrg-0-auto">
                    <div className="welcome margin-30px-left-right">
                        ...
                        <img className="max-width-50" src={"https://www.louisianafcu.org/hs-fs/hubfs/Blog_The%20polite%20persons%20guide%20to%20splitting%20the%20bill%20(558%20%C3%97%20325%20px).png?width=837&name=Blog_The%20polite%20persons%20guide%20to%20splitting%20the%20bill%20(558%20%C3%97%20325%20px).png"} alt="img" />
                    </div>
                </div>
